        ...
        <div className="d-flex px-2 w-100 flex-wrap justify-content-center align-items-center">
          <div className="col-12 mt-4 mb-1 shadow  card text-center px-0">
            <div className="card-header bg_main text-light">
              <h5 className="lh mb-0 fw-bolder ">{post.title}</h5>
            </div>
            <div className="card-body">
              <p className="mb-0 word-wrap">{post.description}</p>
            </div>
          </div>
          <div className="col-12  ">
            <img src={post.profile} alt="" className="w-100 my-2 rounded-3" />
          </div>
          <div className="col-12 border-primary mb-2 shadow card  px-0">
            <div className="card-header bg_main text-light text-center">
              <h5 className="lh mb-0 fw-bolder ">အရေးကြီးအချက်အလက်</h5>
            </div>
              ...
              <table className="table table-bordered border-success mb-0">
                <tbody>
                  <tr>
                    ...
                    <td>
                      {post.game_id}{" "}
                      <span className="text-dark">( {post.server_id} )</span>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      {" "}
                      <span className="fw-bolder h5">{post.price} ကျပ်</span>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      {" "}
                      <span className="px-5 py-2 bg-success rounded-3 text-light">
                        {post.security}
                      </span>{" "}
                    </td>
                  </tr>
          ...
          <div className="col-12 card shadow mt-2">
            ...
            <div className="card-body p-2">
              {post.photos.map((skin, index) => (
                <img src={skin} key={index} className="w-100 mb-1" />
              ))}

              {post.skins.map((skin, index) => (
                <img src={skin} key={index} className="w-100 mb-1" />
              ))}
            </div>
          </div>
          <div className="col-12 card border_main mt-2 shadow mb-5">
            <div className="card-header bg_main text-light text-center">
              <h5 className="mb-0 fw-bolder">How to buy?</h5>
            </div>
            <div className="card-body">
              <Link
                to={post.account? post.account : "https://m.facebook.com/profile.php?id=100059336683324"}
                className="btn btn-primary text-light w-100 py-2"
              >
                <FiMessageCircle /> စာပို့မည်
              </Link>
              <Link
                to={post.phone? "tel:"+post.phone :"tel:+959971404793"}
                className="btn btn-dark mt-2 text-light w-100 py-2"
              >
                <FiPhoneCall /> ဖုန်းဆက်မည်
              </Link>
            </div>
          </div>
        </div>
