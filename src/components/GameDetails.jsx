      ...
      {game && (
        <div className="d-flex flex-wrap justify-content-center align-items-center mb-5">
          <div className="d-flex col-12 flex-wrap align-items-start justify-content-center">
            ...
            <h5 className="col-12 my-1 text-center">
              <div className="col-12 px-0 text-center ">
                <Badge
                  pill bg="danger" className="font-weight-bold  px-3 py-2 my-1 mx-1"
                >
                  ဇာတ်လမ်းသွား
                </Badge>
                <Badge
          ...
          <div className="col-12 col-md-7 mx-auto px-0 mt-2">
                <table className="table table-bordered mx-0 px-0 w-100 table-striped">
                    <tbody>
                        <tr>
                            <td> <FiCpu className="text-primary"/> &nbsp; Company</td>
                            <td>{game.developer}</td>
                        </tr>
                        <tr>
                            <td> <FiCalendar className="text-primary"/> &nbsp; Updated</td>
                            <td>{game.updated}</td>
                        </tr>
                        <tr>
                            <td> <FiSave className="text-primary"/>&nbsp; Size</td>
                            <td>{game.size}</td>
                        </tr>
                        <tr>
                            <td> <FiLayers className="text-primary"/>&nbsp; Version</td>
                            <td>{game.version}</td>
                        </tr>
                        <tr>
                            <td> <FiSettings className="text-primary"/>&nbsp; Requierment</td>
                            <td> {game.requirement}</td>
                        </tr>
                        <tr>
                            <td> <FiPackage className="text-primary"/>&nbsp; Type</td>
                            <td> {game.type}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div className="col-12 pt-2  text-center details_title">
                ...
                <h4 className="col-12 font-weight-bolder my-3 pb-0 fw-bolder text-center ">ဒီမှာဒေါင်းပါ</h4>                
                 <Link to={`/download/${game.slug}`} className="btn btn-primary px-4 py-2">Download Now</Link>
